...
HD_PWD='C:/Users/shubh/logic_gates/logic_gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_gates.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_gates.tcl -notrace
